---
name: sem
description: Entity-level semantic diff on top of Git. Use when analyzing what functions/classes changed, computing impact of a refactor, or getting per-entity blame. Commands: sem diff, blame, graph, impact.
---
